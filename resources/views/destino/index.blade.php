										...
										<td >{{ $destino->provincia }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('destino.destroy', $destino->id_destino) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('destino.show', $destino->id_destino) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('destino.edit', $destino->id_destino) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
