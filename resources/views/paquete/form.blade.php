<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_solicitud" class="form-control @error('id_solicitud') is-invalid @enderror" value="{{ old('id_solicitud', $paquete?->id_solicitud) }}" id="id_solicitud" placeholder="Id Solicitud">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="cantidad_total" class="form-control @error('cantidad_total') is-invalid @enderror" value="{{ old('cantidad_total', $paquete?->cantidad_total) }}" id="cantidad_total" placeholder="Cantidad Total">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="estado_entrega" class="form-control @error('estado_entrega') is-invalid @enderror" value="{{ old('estado_entrega', $paquete?->estado_entrega) }}" id="estado_entrega" placeholder="Estado Entrega">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="ubicacion_actual" class="form-control @error('ubicacion_actual') is-invalid @enderror" value="{{ old('ubicacion_actual', $paquete?->ubicacion_actual) }}" id="ubicacion_actual" placeholder="Ubicacion Actual">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_entrega" class="form-control @error('fecha_entrega') is-invalid @enderror" value="{{ old('fecha_entrega', $paquete?->fecha_entrega) }}" id="fecha_entrega" placeholder="Fecha Entrega">
