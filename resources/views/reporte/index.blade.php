										...
										<td >{{ $reporte->gestion }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('reporte.destroy', $reporte->id_reporte) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('reporte.show', $reporte->id_reporte) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('reporte.edit', $reporte->id_reporte) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
