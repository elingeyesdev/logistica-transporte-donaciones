<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="active" class="form-control @error('active') is-invalid @enderror" value="{{ old('active', $usuario?->active) }}" id="active" placeholder="Active">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="admin" class="form-control @error('admin') is-invalid @enderror" value="{{ old('admin', $usuario?->admin) }}" id="admin" placeholder="Admin">
